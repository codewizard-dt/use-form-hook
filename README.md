- [Dynamic React Forms](#dynamic-react-forms)
  - [A Form component exposed by a hook](#a-form-component-exposed-by-a-hook)
- [Table of Contents](#table-of-contents)
- [Installation](#installation)
- [Usage](#usage)
  - [Import Semantic UI Global Css](#import-semantic-ui-global-css)
  - [Put `FormProvider` in your app layout](#put-formprovider-in-your-app-layout)
  - [Call `useForm` hook to expose the `Form` component](#call-useform-hook-to-expose-the-form-component)
  - [Provide the `Form` element with `fields`, `submit`, and `respond` properties](#provide-the-form-element-with-fields-submit-and-respond-properties)
    - [Provide `fields` property as an array of objects](#provide-fields-property-as-an-array-of-objects)
- [Creating Fields](#creating-fields)
  - [Field Properties](#field-properties)
  - [Field Group Properties](#field-group-properties)
  - [The Form Data Object](#the-form-data-object)
    - [Provide `submit` property as a function](#provide-submit-property-as-a-function)
    - [Provide `respond` property as a function](#provide-respond-property-as-a-function)
- [License](#license)
- [Contributing](#contributing)
- [Tests](#tests)
- [Questions](#questions)
  - [Gimme Readme](#gimme-readme)
<!-- @format -->
